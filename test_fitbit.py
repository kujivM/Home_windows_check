...
def main():
    ...
    # 2. 睡眠データ (sleep-session -> sleep に修正)
    print("\n[ FETCHING SLEEP DATA ]")
    sleep_url = "https://health.googleapis.com/v4/users/me/dataTypes/sleep/dataPoints?pageSize=1"
    ...
    # 3. 活動データ (step-count -> steps に修正)
    print("\n[ FETCHING ACTIVITY DATA (STEPS) ]")
    activity_url = "https://health.googleapis.com/v4/users/me/dataTypes/steps/dataPoints?pageSize=1"
